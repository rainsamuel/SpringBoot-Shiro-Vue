package com.rainsamuel.disklink.config.filter;
...
import com.rainsamuel.disklink.config.exception.UnauthorizedException;
import com.rainsamuel.disklink.dto.session.SessionUserInfo;
import com.rainsamuel.disklink.service.TokenService;
...
public class PermissionAspect {
    ...
    @Before("@annotation(com.rainsamuel.disklink.config.annotation.RequiresPermissions)")
